...
Pod::Spec.new do |spec|
  ...
  spec.resource_bundles = { 'TBMtimeCommon' => ['TBMtimeCommon/Assets.xcassets', 'TBMtimeCommon/**/*.{xib,storyboard}'] }
  ...
  # 当前项目所依赖的第三方库 都需要对外暴露
   ...
   spec.dependency 'SwiftLint', '0.42.0', :configurations => ['Debug']
